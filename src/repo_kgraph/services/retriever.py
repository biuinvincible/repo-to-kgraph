...
class ContextRetriever:
    ...
    def _calculate_hybrid_score(self, result: ContextResult, query: Query) -> float:
        ...
        similarity_score = result.relevance_score if result.retrieval_reason == RetrievalReason.SEMANTIC_SIMILARITY else 0.0
        graph_score = result.relevance_score if result.retrieval_reason == RetrievalReason.GRAPH_TRAVERSAL else 0.0
